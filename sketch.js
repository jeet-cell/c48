...
resetimg = loadImage("resetbutton.png");
  ...
  die = loadSound("die1.mp3")

  collect = loadSound("coinwin.mp3")
}
...
if (frameCount % 150 === 0) {
    var coin= createSprite(400,0,40,10);
    coin.x = Math.round(random(width/1.5,width/5.5));
    coin.addImage(coinImg);
    coin.scale = 0.1
    coin.velocityY = Math.round(random(8,20))
    
     //assign lifetime to the variable
    coin.lifetime = 200;
    
       // car.debug= true;
    coin.setCollider("rectangle",10,0,130,400)
